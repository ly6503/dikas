...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/sb-template-persistence/src/main/java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test?useUnicode=true&&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT&&allowPublicKeyRetrieval=true");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("Hx123456!");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        // 模块名
        pc.setModuleName("sb.template");
        // 父包名
        pc.setParent("top.ryan1h");
        pc.setEntity("domain");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/sb-template-persistence/src/main/resources/mappers"
        ...
        strategy.setSuperEntityClass("top.ryan1h.sb.template.domain.BaseBean");
        strategy.setEntityLombokModel(false);
        strategy.setRestControllerStyle(true);
        strategy.setSuperControllerClass("top.ryan1h.sb.template.web.api.controller.BaseController");
